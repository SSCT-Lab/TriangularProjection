...
class FuzzQueue(object):
    ...
    def __init__(self, outdir, is_random, sample_type, cov_num, criteria,coverage_handler=None):
        """Init the class.
        """
    ...
    def has_new_bits(self, seed):
        ...
        # print("cov", np.sum(seed.coverage), len(seed.coverage))
