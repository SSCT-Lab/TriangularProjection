...
class CovRank(object):
    ...
    def cal_nac_cov(self, t=0.75):
        ...
        return rate, nac.t_collection, rank_lst, nac.t_cam, None, None
    ...
    def cal_nbc_cov(self, std=0):  # 0 0.5 1
        ...
        return rate, nbc.t_collection, rank_lst, nbc.t_cam, None, None
    ...
    def cal_snac_cov(self, std=0):  # 0 0.5 1
        ...
        return rate, snac.t_collection, rank_lst, snac.t_cam, None, None
